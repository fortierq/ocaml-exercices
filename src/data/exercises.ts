...
export const exercises: Exercise[] = [
  {
    ...
    title: 'Factorial',
    titleFr: 'Factorielle',
    description: 'Write a recursive function `factorial` that computes n! (n factorial). Remember that 0! = 1.',
    descriptionFr: 'Écrivez une fonction récursive `factorial` qui calcule n! (factorielle de n). Rappelez-vous que 0! = 1.',
    difficulty: 'easy',
    category: 'Recursion',
...
let () =
  ...
  },
  {
    ...
    description: 'Write a function `fold_left` that reduces a list from left to right using a combining function and an initial accumulator.',
    descriptionFr: 'Écrivez une fonction `fold_left` qui réduit une liste de gauche à droite en utilisant une fonction de combinaison et un accumulateur initial.',
    difficulty: 'medium',
    category: 'Higher-Order Functions',
    categoryFr: 'Fonctions d\'Ordre Supérieur',
